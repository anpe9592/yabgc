...
class Game {
  ...
  create () {
    ...
    graphics.drawRect(395, 350, 10, 250) // <-- the green rectangle

    this.analog = this.add.sprite(400, 350, 'analog') // <-- fusia.png
    ...
    this.arrow = this.add.sprite(400, 350, 'arrow') // <--- longarrow2.png
